 ...
 * @author ibanez-l
 */
public class EcoNamedGraphTest {
  ...
  String select;
  Mappings map;
  String TEST1G1 = "<http://g1.org/test1>";
  String TEST2G1 = "<http://g1.org/test2>";
  String TEST1G2 = "<http://g2.org/test2>";
  String TEST2G2 = "<http://g2.org/test2>";
  
  public EcoNamedGraphTest() {
	g1 = new EcoGraph("G1");	
	g2 = new EcoGraph("G2");	
  ...
  //@Test
  public void testInsertNGDataSimple() throws Exception {
  
	System.out.println("INSERT NG DATA simple");
	...
	assertEquals(4,g1.sizeOfGraph("<http://g1.org/test1>"));
	assertEquals(4,g1.cardinalityOfGraph("<http://g1.org/test1>"));
  ...
  //@Test 
  public void testInsertNGDataDouble() throws EngineException {
	//Insert repeated triples
	System.out.println("INSERT NG DATA Two Distinct graphs");
	insert1 = "PREFIX dc: <http://purl.org/dc/elements/1.1/> "
			+ "INSERT DATA {"
            + "GRAPH " + TEST1G1 + "{"
			+ "<http://example/book1> dc:title 'A new book'."
	...
	assertEquals(4,g1.size());
	assertEquals(4,g1.cardinality());
	assertEquals(2,g1.sizeOfGraph(TEST1G1));
	assertEquals(2,g1.cardinalityOfGraph(TEST1G1));
	assertEquals(2,g1.sizeOfGraph(TEST2G1));
	assertEquals(2,g1.cardinalityOfGraph(TEST2G1));
  ...
  //@Test 
  public void testInsertSameDataDiffGraphs() throws EngineException {
	//Insert repeated triples
	System.out.println("INSERT DATA Same triples on different graphs");
	insert1 = "PREFIX dc: <http://purl.org/dc/elements/1.1/> "
			+ "INSERT DATA {"
            + "GRAPH " + TEST1G1 + "{"
			+ "<http://example/book1> dc:title 'A new book'."
	...
	assertEquals(4,g1.sizeOfGraph(TEST1G1));
	assertEquals(4,g1.cardinalityOfGraph(TEST1G1));
	assertEquals(2,g1.sizeOfGraph(TEST2G1));
	assertEquals(2,g1.cardinalityOfGraph(TEST2G1));
	// TODO Vector changed
...
*/
  ...
  //@Test
  public void testDeleteNonExistantGraph() throws EngineException{

	System.out.println("DELETE DATA from a graph where it does not exists");
  ...
  public void testDeleteSomeExistant() throws Exception{
	...
	System.out.println("DELETE DATA partially from a named graph");
  ...
  // TODO test the different flavors of CLEAR.
  //@Test
 ...
 //@Test 
  ...
  @Test
  public void testTwoInsertsDisjointNG() throws EngineException{
  
	System.out.println("INSERT same on different named graphs ");
	insert1 = "PREFIX dc: <http://purl.org/dc/elements/1.1/> "
			+ "INSERT DATA {"
            + "GRAPH " + TEST1G1 + "{"
			+ "<http://example/book2> dc:creator 'Balzac' ."
	...
	assertEquals(2,receiver1.cardinalityOfGraph(TEST1G1));
	assertEquals(2,receiver1.cardinalityOfGraph(TEST1G1));
	assertEquals(2,receiver2.cardinalityOfGraph(TEST1G2));
	assertEquals(2,receiver2.cardinalityOfGraph(TEST1G2));
    // TODO, change to sameStorewhen implemented
  ...
  @Test
  public void testInsertSameGraphName() throws EngineException{
  
	System.out.println("Two stores create a graph with the same IRI, is the same graph"
            + "but different triples until sync time.");
	insert1 = "PREFIX dc: <http://purl.org/dc/elements/1.1/> "
			+ "INSERT DATA {"
            + "GRAPH " + TEST1G1 + "{"
			+ "<http://example/book2> dc:creator 'Balzac' ."
	...
	System.out.println(gr2.display());
	*/
	assertEquals(8,receiver1.sizeOfGraph(TEST1G1));
	assertEquals(8,receiver2.sizeOfGraph(TEST1G1));
	assertEquals(receiver1.cardinalityOfGraph(TEST1G1),4);
	assertEquals(receiver2.cardinalityOfGraph(TEST1G1),4);
...
@Test
public void testCopy() throws EngineException{

	System.out.println("Two Copies from the same graph to a different one");
    ...
    String copy1= "PREFIX dc: <http://purl.org/dc/elements/1.1/> "
            + "COPY GRAPH "+ TEST1G1 + " TO " + TEST1G2; 

    String copy2= "PREFIX dc: <http://purl.org/dc/elements/1.1/> "
            + "COPY GRAPH "+ TEST1G1 + " TO " + TEST2G1; 
...
@Test
public void testMove() throws EngineException{

	System.out.println("Two Moves from the same graph to a different one");
    ...
    String move1= "PREFIX dc: <http://purl.org/dc/elements/1.1/> "
            + "MOVE GRAPH "+ TEST1G1 + " TO " + TEST1G2; 

    String move2= "PREFIX dc: <http://purl.org/dc/elements/1.1/> "
            + "MOVE GRAPH "+ TEST1G1 + " TO " + TEST2G1; 
...
@Test
public void testAdd() throws EngineException{

	System.out.println("Two Adds from the same graph to a different one");
    ...
    String add1= "PREFIX dc: <http://purl.org/dc/elements/1.1/> "
            + "ADD GRAPH "+ TEST1G1 + " TO " + TEST1G2; 

    String add2= "PREFIX dc: <http://purl.org/dc/elements/1.1/> "
            + "ADD GRAPH "+ TEST1G1 + " TO " + TEST2G1; 
...
//@Test
public void testDropGraph() throws EngineException{
	...
	insert2 = "PREFIX dc: <http://purl.org/dc/elements/1.1/> "
			...
			+ "<http://example/book1> dc:title 'A new book'."
			+ "<http://example/book1> dc:creator 'A.N. Other' ."
			+ "<http://example/book2> dc:creator 'Verne' ."
			+ "<http://example/book2> dc:title 'Paris au XX siecle'."
			+ "}}";
    
    g2.query(insert1);
    IVOperation op1 = g1.getLastOperation();
    System.out.println(op1.serialize());
    g2.applyEffect(op1);

    String drop = "DROP GRAPH " + TEST1G1;
    g1.query(drop);
    op1 = g1.getLastOperation();
    System.out.println(op1.serialize());
    g2.applyEffect(op1);

	assertEquals(0,g1.sizeOfGraph(TEST1G1));
	assertEquals(4,g2.sizeOfGraph(TEST1G1));
  ...
  // Insert with the tuple keyword works
  // to mock the LOAD
  @Test
  public void testTupleInsert() throws EngineException{
  
	insert1 = "PREFIX dc: <http://purl.org/dc/elements/1.1/> "
			+ "INSERT DATA {"
        + "tuple(dc:creator <http://example/book2> 'Balzac' 'example.com/site1#1237')"
        + "tuple(dc:creator <http://example/book1> 'A.N. Other' 'example.com/site1#1237')"
            + "}";

	insert2 = "PREFIX dc: <http://purl.org/dc/elements/1.1/> "
			+ "INSERT DATA {"
        + "tuple(dc:creator <http://example/book2> 'Balzac' 'example.com/site2#2374')"
        + "tuple(dc:creator <http://example/book1> 'A.N. Other' 'example.com/site3#2379')"
            + "}";
