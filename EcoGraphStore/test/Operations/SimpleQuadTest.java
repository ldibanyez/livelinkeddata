...
public class SimpleQuadTest {
    ...
    public void testToString() {
        ...
        assertEquals(("<"+RESOURCE+"> <"+RESOURCEP+"> <"+RESOURCE2+"> <"+GRAPH1+">"),sq.toString());
        sq = new SimpleQuad(GRAPH1,RESOURCE,RESOURCEP,LITERAL);
        assertEquals(("<"+RESOURCE+"> <"+RESOURCEP+"> \""+LITERAL+"\" <"+GRAPH1+">"),sq.toString());

        // But it is printed as "DEFAULT"
        sq = new SimpleQuad("DEFAULT",RESOURCE,RESOURCEP,LITERAL);
        assertEquals(("<"+RESOURCE+"> <"+RESOURCEP+"> \""+LITERAL+"\" DEFAULT"),sq.toString());
