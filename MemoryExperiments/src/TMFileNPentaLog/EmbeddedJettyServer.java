...
//        logger.debug("Started.");
        ...
        Option nameOpt = new Option("n", "name", true, "Name to assign to the graph");
        ...
        try {
            ...
            if (cmd.hasOption("n")) {
                ...
                throw new Error("Please specify a name/id for the graph");
            } 
            ...
            jerseyServletHolder.setInitParameter("com.sun.jersey.config.property.packages", "TMFileNPentaLog");
