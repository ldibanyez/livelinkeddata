...
public class TMGraphTest {
 ...
 @Test 
  ...
  public void testDelete4() throws EngineException{
    ...
    @Test
    public void testLoad() throws EngineException{
       
       String load = "LOAD <http://localhost/~luisdanielibanesgonzalez/datasets/ObjectFrance.ttl> INTO GRAPH <kg:default>";
       g1.query(load);
       for(Entity ent : g1.getGraph().getEdges()){
           assertFalse(ent.getNode(2).getLabel().equals("")); 
       }
