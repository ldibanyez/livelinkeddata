...
public class testService {
    ...
    public static void main(String [] args ) throws FileSystemException, URISyntaxException{
        ...
        String logRes = service.path("sparql").path("log").queryParams(formData).accept(MediaType.APPLICATION_JSON).get(String.class);

        // Deserialization of a collection with Gson
        Gson gson = new Gson();
        Type listType = new TypeToken<List<TMOperation>>(){}.getType();
        List<TMOperation> ops = gson.fromJson(logRes, listType);
