...
public class MemTMGraphIncrementalDelete {
  ...
  public void prepare() throws URISyntaxException {
    ...
    Helper.reloadEndpoint(endpoint, basedata);
      ...
      */
	  ...
	  //Logger.getLogger(MemTMGraphIncrementalDelete.class.getName()).log(Level.INFO, "Target size before = {0}", target.size());
  ...
  public void check(){
	  ...
	  //Logger.getLogger(MemTMGraphIncrementalDelete.class.getName())
